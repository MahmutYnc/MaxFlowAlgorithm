...
public class Graf extends javax.swing.JFrame {
    ...
    private int[][] connectionMatris;
    public Graf() {
        initComponents();
    }
    public Graf(int nodeCount, String[] nodes, String source, String sink, int[][] connectionMatris) {
        this.nodeCount = nodeCount;
        this.nodes = nodes;
        this.source = source;
        this.sink = sink;
        this.connectionMatris = connectionMatris;
        initComponents();
    }
    private JButton buttons[] = new JButton[nodeCount];
